jQuery(document).ready(function(){
    ...
    jQuery("#amazingslider-2").amazingslider({
        ...
        shadowcolor:"#aaaaaa",
        textbgcss:"display:block; position:absolute; top:0px; right:0px; width:100%; height:100%;  opacity:0.6; filter:alpha(opacity=60);",
        ...
        transition:"blocks,cssslide,slide,kenburns",
        scalemode:"fill",
        isfullscreen:false,
        textformat: {
