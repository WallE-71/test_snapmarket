...
(function (factory) {
    ...
    $.fn.fileinputLocales.en = {
        fileSingle: 'file',
        filePlural: 'files',
        browseLabel: 'انتخاب کنید &hellip;',
        removeLabel: 'حذف',
        removeTitle: 'Clear all unprocessed files',
        cancelLabel: 'انصراف',
        cancelTitle: 'Abort ongoing upload',
        pauseLabel: 'توقف آپلود',
        ...
        msgPaused: 'توقف',
        msgPlaceholder: 'تصاویر را انتخاب کنید...',
        ...
        msgFilesTooMany: 'حداکثر تعداد فایل های مجاز برای آپلود <b>{m}</b> است.',
        ...
        msgUploadAborted: 'خطایی رخ داده است!',
        msgUploadThreshold: 'در حال پردازش ...',
        msgUploadBegin: 'شروع...',
        msgUploadEnd: 'عملیات انجام شد.',
        msgUploadResume: 'ادامه آپلود...',
        msgUploadEmpty: 'No valid data available for upload.',
        msgUploadError: 'در آپلود فایل خطایی رخ داده است.',
        msgDeleteError: 'خطای در حذف',
        msgProgressError: 'خطا',
        msgValidationError: 'خطا در اعتبارسنجی',
        msgLoading: 'در حال بارگزاری تصاویر &hellip;',
        msgProgress: 'بارگزاری تصاویر - {percent}% درصد کامل شد.',
        msgSelected: '{n} تصویر انتخاب شد',
        ...
        msgDuplicateFile: 'فایل "{name}" با حجم "{size} KB" قبلا انتخاب شده و تکراری است.',
        msgResumableUploadRetriesExceeded: 'Upload aborted beyond <b>{max}</b> retries for file <b>{file}</b>! Error Details: <pre>{error}</pre>',
        msgPendingTime: '{time} باقی مانده',
        msgCalculatingTime: 'محاسبه زمان باقی مانده',
        ajaxOperations: {
            deleteThumb: 'فایل حذف شد',
            uploadThumb: 'فایل آپلود شد',
            uploadBatch: 'batch file upload',
            uploadExtra: 'form data upload'
        },
        dropZoneTitle: 'تصاویر را انتخاب نمایید... ',
        dropZoneClickTitle: ' <small>(یا اینجا قرار دهید)</small> &hellip;',
